...
class RoutesTest < ActionController::IntegrationTest
  test "generated queries routes" do
    ...
    assert_recognizes({:controller => "generated_queries", :action => "index"}, {:path => query_generator_generated_queries_path, :method => :get})
    ...
    assert_recognizes({:controller => "generated_queries", :action => "set_main_model"}, {:path => set_main_model_query_generator_generated_queries_path, :method => :post})
    ...
    assert_recognizes({:controller => "generated_queries", :action => "preview_model_records"}, {:path => preview_model_records_query_generator_generated_queries_path, :method => :get})
    ...
    assert_recognizes({:controller => "generated_queries", :action => "add_association"}, {:path => add_association_query_generator_generated_queries_path, :method => :post})

    #remove_model action
    assert_generates "/generated_queries/remove_model", { :controller => "generated_queries", :action => "remove_model"}
    assert_recognizes({:controller => "generated_queries", :action => "remove_model"}, {:path => remove_model_query_generator_generated_queries_path, :method => :post})
    ...
    assert_recognizes({:controller => "generated_queries", :action => "load_previous_wizard_step"}, {:path => load_previous_wizard_step_query_generator_generated_queries_path, :method => :get})
  end
end
